...
public class ModelExport
{
    ...
    public static string ConstructEnum(Type enumerType, string directory)
    {
        ...
        using (FileStream fs = File.Create(filePath))
        {
            ...
            byte[] lineOne = new UTF8Encoding(true).GetBytes("import Enum from 'elevuetor-js/data-types/enum';\r\n\r\n");
    ...
    public static string ConstructModel(Type modelType, string directory)
    {
        ...
        foreach (var modelProperty in modelProperties)
        {
            ...
            if (vuePropertyTypeAttribute != null)
            {
                ...
                {
                    imports.Add($"import {propertyTypeName} from 'elevuetor-js/data-types/bit-array';");
                }
                else if (propertyTypeName == "Flag")
                {
                    imports.Add($"import {propertyTypeName} from 'elevuetor-js/data-types/flag';");
                }
            ...
            } else if (modelPropertyType == typeof(Guid))
            {
                ...
                imports.Add($"import Guid from 'elevuetor-js/data-types/guid';");
            ...
            {
                imports.Add($"import ByteArray from 'elevuetor-js/data-types/byte-array';");
                propertyTypeName = "ByteArray";
                enumerable = false;
            } else if (modelPropertyType.Name == "Point")
            {
                propertyTypeName = modelPropertyType.Name;
                imports.Add($"import Point from 'elevuetor-js/data-types/point';");
        ...
        using (FileStream fs = File.Create(filePath))
        {
            ...
            lines.Add("//This file was generated by ElevuetorDotNet, do not modify directly as your changes will be lost.");
            lines.Add("import Model from 'elevuetor-js/data-types/model';");
